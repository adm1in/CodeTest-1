    ...
    def cve_2018_7602(self):
        ...
        try:
            if VULN == 'False':
                ...
                self.r = self.session.get(self.url, params=self.get_params, headers=self.headers, timeout=TIMEOUT, verify=False)
...
def check(**kwargs):
    ...
    if kwargs['pocname'] != 'ALL':
        ...
        for func in dir(Drupal):
            if not func.startswith("__"):
                methodcaller(func)(ExpDrupal)
